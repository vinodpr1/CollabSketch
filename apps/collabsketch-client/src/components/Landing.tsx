...
function Landing() {
  ...
  return (
    ...
    >
      {/* Fancy Header */}
      <header
        className={`fixed top-0 left-0 right-0 z-50 border-b ${isDark ? "border-gray-800" : "border-gray-200"} ${isDark ? "bg-gray-900/80" : "bg-white/80"} backdrop-blur-md`}
      >
        ...
        <div className="container mx-auto px-6 py-20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center space-x-4">
              ...
              >
                <button
                  className={`border ${isDark ? "border-gray-700" : "border-gray-300"} hover:border-purple-500 px-8 py-3 rounded-lg flex items-center space-x-2 transition-colors`}
                >
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-20">
            <div
              className={`${isDark ? "bg-gray-800/50" : "bg-white"} p-6 rounded-xl border ${isDark ? "border-gray-700" : "border-gray-200"} hover:border-purple-500 transition-colors`}
            >
          ...
          <div className="mt-32">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div
                className={`${isDark ? "bg-gray-800/50" : "bg-white"} p-8 rounded-xl border ${isDark ? "border-gray-700" : "border-gray-200"}`}
              >
          ...
          {/* Stats Section */}
          <div
            className={`mt-32 ${isDark ? "bg-gray-800/50" : "bg-white"} rounded-2xl border ${isDark ? "border-gray-700" : "border-gray-200"} p-12`}
          >
      ...
      {/* Footer */}
      <footer
        className={`border-t ${isDark ? "border-gray-800" : "border-gray-200"} mt-32`}
      >
        <div className="container mx-auto px-6 py-12">
          ...
          <div
            className={`border-t ${isDark ? "border-gray-800" : "border-gray-200"} mt-12 pt-8 text-center ${isDark ? "text-gray-400" : "text-gray-600"}`}
          >
