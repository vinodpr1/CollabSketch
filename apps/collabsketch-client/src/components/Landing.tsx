...
import {
    Pencil, Share2, Users, Sparkles, ChevronRight, Github,
    Palette, Layers, Download, Lock, Star, Heart,
    Twitter, Linkedin, Facebook, LogIn, LogOut, User, ChevronDown
} from 'lucide-react';
                ...
                <div className="container mx-auto px-6 py-20">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mt-20">
                        <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-purple-500 transition-colors">
                            ...
                            <p className="text-gray-400">Work together with your team in real-time, no matter where they are.</p>
                        </div>
                        <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-purple-500 transition-colors">
                            <div className="bg-purple-900/30 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                            ...
                            <p className="text-gray-400">Multiple users can edit the same canvas simultaneously without conflicts.</p>
                        </div>
                        <div className="bg-gray-800/50 p-6 rounded-xl border border-gray-700 hover:border-purple-500 transition-colors">
                            <div className="bg-purple-900/30 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                            ...
                            <p className="text-gray-400">Create stunning hand-drawn diagrams that look professional and engaging.</p>
                        </div>
                    </div>
                            ...
                            <div className="space-y-8">
                                <div className="flex items-start space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400">Access a wide range of drawing tools designed for both simplicity and power.</p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-4">
                                    <div className="bg-purple-900/30 p-3 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400">Organize your drawings with intelligent layer management and grouping.</p>
                                    </div>
                                </div>
                                <div className="flex items-start space-x-4">
                                    <div className="bg-purple-900/30 p-3 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400">Export your work in multiple formats including PNG, SVG, and more.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="mt-32">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
                                ...
                                <p className="text-gray-300">"The perfect tool for quick wireframes and design discussions. Love the collaboration features!"</p>
                            </div>
                            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
                                <div className="flex items-center mb-4">
                                    <img
                                ...
                                <p className="text-gray-300">"Excalidraw has revolutionized how our team brainstorms and plans new features."</p>
                            </div>
                            <div className="bg-gray-800/50 p-8 rounded-xl border border-gray-700">
                                <div className="flex items-center mb-4">
                                    <img
                                ...
                                <p className="text-gray-300">"The best whiteboarding tool I've used. Clean, simple, and incredibly powerful."</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-32 text-center">
                        ...
                        <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
                            Join millions of creators and teams who use Excalidraw to bring their ideas to life.
                        </p>
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 text-gray-400">
                                ...
                                <li><a href="#" className="hover:text-purple-400 transition-colors">Libraries</a></li>
